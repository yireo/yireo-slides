...
~ Magento-based FPC for GraphQL endpoints
  ...
  - Uses `@cache(cacheIdentity: classX)` to manage cache tags
~ Varnish-based FPC
  - Supported by VCL file generated by Magento Admin Panel
  - See docs for `process_graphql_headers` VCL subroutine
